...
from OptSched import RE_DAG_COST, RE_PASS_NUM, RE_SCHED_LENGTH, getBenchmarkFilePaths
        ...
        if os.path.exists(filePaths[bench]):
            ...
            with open(filePaths[bench]) as file:
                ...
                for block in blocks:
                    ...
                    DAGInfo = RE_DAG_COST.search(block)
                    if (DAGInfo):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--verbose', '-v', action='store_true', default=False,
                        dest='verbose', help='Print average schedule lengths to terminal')

    parser.add_argument('--output', '-o', dest='output',
                        help='Output spreadsheet filepath')

    parser.add_argument('--disable', '-d', action='store_true',
                        default=False, dest='disable', help='Disable spreadsheet output.')
